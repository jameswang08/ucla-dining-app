    ...
    return(
        <div>
            ...
            <div className="prose ps-32 pt-32 pb-8">
                ...
                <text className="text-white">Check out UCLA’s amazing food trucks!</text>
            </div>
            {"\n\n\n"}
            <div className="flex">
                <div className="prose w-1/2 ml-32 mr-4">
                    <h2 className="text-light-yellow mb-2 font-medium">Normal Hours Food Trucks</h2>
                ...
                <div className="prose w-1/2 mr-32 ml-4">
                    <h2 className="text-light-yellow mb-2 font-medium">Late Night Only Food Trucks</h2>
                    <div className="text-white">
                        
                        <h3 className="text-white mt-2 font-base">BittieBitez Mini-Donuts</h3>
                        {"  "}
                        <text>_._</text>
                        <div className="rating rating-xs">
                            <input type="radio" name="rating-2" className="mask mask-star-2 bg-white" checked />
                    ...
                    <div className="bg-medium-grey text-white my-4 px-2 py-2">
                        <text>Donut truck in Southern California providing fresh made mini donuts food truck with a variety of toppings from chocolate, oreo, to Fruity Pebbles.</text>
                    </div>
                    <button className="btn btn-active btn-link underline decoration-dark-yellow text-white">
                        EXPLORE
                    </button>
